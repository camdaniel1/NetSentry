...
SIMULATIONS = (
    ...
    Simulation("evil twin", "scripts.simulate_evil_twin", target_flag=None, needs_ssid=True),
    Simulation("ICMP flood", "scripts.simulate_icmp_flood"),
    Simulation("IP spoofing", "scripts.simulate_ip_spoofing"),
    Simulation("packet sniffing indicator", "scripts.simulate_packet_sniffing"),
    ...
    Simulation("UDP flood", "scripts.simulate_udp_flood"),
)
