...
VAULT_DIR = project_path(str(setting("evidence.vault_directory")))

# rotate to a new file once the active one reaches this size
MAX_FILE_SIZE_BYTES = int(float(setting("evidence.max_file_size_mb")) * 1024 * 1024)

# files older than this get pruned by prune_expired()
DEFAULT_RETENTION_DAYS = int(setting("evidence.retention_days"))
