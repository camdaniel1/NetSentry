...
TIME_WINDOW_SECONDS = float(setting("correlation.grouping_window_seconds"))
GROUPING_LIMIT = int(setting("correlation.grouping_limit"))
...
def run_grouping(limit: int = GROUPING_LIMIT) -> int:
    """
