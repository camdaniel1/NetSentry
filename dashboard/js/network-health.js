import { DASHBOARD_CONFIG, LIVE_CONTROL_BASE } from "./api.js?v=9";
import { escapeHtml } from "./utils.js?v=3";

const MAX_RECENT = DASHBOARD_CONFIG.healthRecentSamples;
const STORAGE_KEY = "netsentry.networkHealth.v1";
const MAX_AGE_MS = DASHBOARD_CONFIG.healthSavedStateMaxAgeHours * 60 * 60 * 1000;
