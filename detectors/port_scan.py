...
PORT_THRESHOLD = int(setting("detectors.port_scan.port_threshold"))
HOST_THRESHOLD = int(setting("detectors.port_scan.host_threshold"))
WEB_HOST_THRESHOLD = int(setting("detectors.port_scan.web_host_threshold"))
WINDOW_SECONDS = float(setting("detectors.port_scan.window_seconds"))
...
class PortScanDetector(Detector):
    ...
    def __init__(self, port_threshold: int = PORT_THRESHOLD,
                 ...
                 web_host_threshold: int = WEB_HOST_THRESHOLD) -> None:
