...
SYN_THRESHOLD = int(setting("detectors.syn_flood.syn_threshold"))
WINDOW_SECONDS = float(setting("detectors.syn_flood.window_seconds"))


class SynFloodDetector(Detector):
    name = "syn_flood"

    def __init__(self, syn_threshold: int = SYN_THRESHOLD, window_seconds: float = WINDOW_SECONDS) -> None:
